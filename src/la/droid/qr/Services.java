 ...
 * This is part of "QRDroidServices", by DroidLa. If you're creating an Android
 * app which uses one or more services provided by "QR Droid", you can use this
 * code for free, and modify it as you need, for personal and commercial use.
 * 
...
public class Services extends TabActivity {
	...
	// Parameters
	// SCAN / DECODE
	public static final String COMPLETE = "la.droid.qr.complete"; // Default:
																	// false
	// ENCODE
	...
	// ENCODE / DECODE
	public static final String IMAGE = "la.droid.qr.image"; // Default for
															// encode: false /
															// Required for
															// decode
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		spec = tabHost.newTabSpec("Scan")
				.setIndicator("", res.getDrawable(R.drawable.camera))
				.setContent(intent);
		tabHost.addTab(spec);

		// Encode Activity
		intent = new Intent().setClass(this, Encode.class);
		spec = tabHost.newTabSpec("Encode")
				.setIndicator("", res.getDrawable(R.drawable.text))
				.setContent(intent);
		tabHost.addTab(spec);

		// Decode Activity
		intent = new Intent().setClass(this, Decode.class);
		spec = tabHost.newTabSpec("Decode")
				.setIndicator("", res.getDrawable(R.drawable.image))
				.setContent(intent);
		tabHost.addTab(spec);
		...
		builder.setMessage(getString(R.string.demo))
				...
				.setNeutralButton(R.string.source,
						new DialogInterface.OnClickListener() {
							@Override
				...
				.setPositiveButton(R.string.qrDroid,
						new DialogInterface.OnClickListener() {
							public void onClick(DialogInterface dialog, int id) {
								try {
									startActivity(new Intent(
	...
	*/
	...
	/**
	 * Display a message stating that QR Droid is requiered, and lets the user
	 * download it for free
	 * 
	 * @param activity
	 */
	public static void qrDroidRequired(final Activity activity) {
		// Apparently, QR Droid is not installed, or it's previous to version
		// 3.5
